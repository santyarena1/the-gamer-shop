...
import { PC_SLOTS, SLOT_LABELS, type LineItemInput, type SearchProductResult } from "@/lib/quote-builder-constants"
...
export default function BuildSlotGrid({ items, onChange, readOnly }: Props) {
  ...
  function handleSelect(result: SearchProductResult) {
    ...
    const line = searchResultToLineItem(result, activeSlot)
